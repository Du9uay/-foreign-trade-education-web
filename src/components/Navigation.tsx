...
const Navigation: React.FC = () => {
  ...
  const courseModules = [
    { name: '外贸业务全景图', path: '/course/automation-industry' },
    { name: '外贸业务框架', path: '/course/plc-basics' },
    { name: '外贸核心流程', path: '/course/io-wiring' },
    { name: '关键角色职责图谱', path: '/course/program-development' },
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-[color:var(--accent-sand-500)] rounded-lg flex items-center justify-center">
              <Cpu className="w-6 h-6 text-[color:var(--bg-ocean-900)]" />
            </div>
                          <span className="text-base-50 font-bold text-lg">外贸业务教学</span>
          </Link>
